define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "{\"query\":\"{ MenuQuery { id,name,slug,refer,menuAccess,created_at,updated_at } }\"}",
        "type": "json"
      }
    ],
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "{\"query\":\"{ RoleQuery { id,name,count,accessMenu{menu_id,access,role_id}created_at,updated_at } }\"}",
        "type": "json"
      }
    ],
